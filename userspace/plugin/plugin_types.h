...
// 0x00000000 to 0x7fffffff are reserved for public use.
// 0x80000000 to 0xffffffff are reserved for private use.
typedef enum ss_plugin_metadata_type {
	...
	// If you want to add a value to this list you can request a public value
	// by opening a pull request at https://github.com/falcosecurity/libs/
	// or self-assign a private value.
	// DO NOT SELF-ASSIGN A PUBLIC VALUE.
