...
std::string gen_event_filter_factory::filter_fieldclass_info::as_string(bool verbose, std::set<std::string> event_sources)
{
...
std::string gen_event_filter_factory::filter_fieldclass_info::as_string(bool verbose)
{
	std::set<std::string> event_sources;

	return as_string(verbose, event_sources);
}
